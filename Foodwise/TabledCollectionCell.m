...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    flowLayout.sectionInset = UIEdgeInsetsMake(0, 5.0, 0, 2.0);
    ...
    [self.collectionView registerClass:[AddPhotoCollectionViewCell class] forCellWithReuseIdentifier:addPhotoCellIdentifier];
